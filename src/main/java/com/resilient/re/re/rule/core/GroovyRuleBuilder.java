...
import com.resilient.re.re.rule.condition.BetweenCondition;
import com.resilient.re.re.rule.condition.Condition;
import com.resilient.re.re.rule.condition.ContainsCondition;
import com.resilient.re.re.rule.condition.EqualsCondition;
...
import static com.resilient.re.re.rule.core.Constants.EMPTY_ARRAY;
