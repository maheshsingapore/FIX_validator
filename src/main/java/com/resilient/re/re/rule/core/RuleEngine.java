...
import com.resilient.re.re.ext.MessageFactory;
import com.resilient.re.re.ext.MessageFactoryImpl;
import com.resilient.re.re.rule.event.Event;
import com.resilient.re.re.rule.result.Result;
import com.resilient.re.re.rule.result.ResultBuilder;
import com.resilient.re.re.rule.result.Results;
